...
git_clone "https://github.com/LacledesLAN/gamesvr-minecraft" "${REPOS_DIR}/gameservers/gamesvr-minecraft"
git_clone "https://github.com/LacledesLAN/gamesvr-minecraft-challenge1" "${REPOS_DIR}/gameservers/gamesvr-minecraft-challenge1"
git_clone "https://github.com/LacledesLAN/gamesvr-minecraft-challenge2" "${REPOS_DIR}/gameservers/gamesvr-minecraft-challenge2"
git_clone "https://github.com/LacledesLAN/gamesvr-minecraft-challenge3" "${REPOS_DIR}/gameservers/gamesvr-minecraft-challenge3"
